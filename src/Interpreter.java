...
public class Interpreter {
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            System.err.println("Usage: java gamelang.Interpreter <source-file>");
            System.exit(1);
        }
        ...
        // Assuming ANTLR generated parser and lexer classes are named GameLangParser and GameLangLexer
        GameLangLexer lexer = new GameLangLexer(CharStreams.fromString(sourceCode));
